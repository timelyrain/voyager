  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center px-4 relative overflow-hidden" style={{ paddingTop: 'env(safe-area-inset-top)', paddingBottom: 'env(safe-area-inset-bottom)' }}>
      ...
      <svg
        ...
        style={{ height: 200 }}
      >
        {/* Back range — 3 distinct peaks */}
        <path
          d="M0,220 L0,158 C100,148 220,132 310,112 C350,103 368,82 385,58 C402,82 422,108 480,122 C540,135 620,130 672,108 C700,96 714,52 722,28 C730,52 744,96 772,108 C824,130 904,135 964,122 C1022,108 1042,82 1060,88 C1078,94 1108,110 1180,118 C1240,126 1330,138 1440,148 L1440,220 Z"
          fill="rgba(3,7,18,0.88)"
        />
        {/* Foreground ridge */}
        <path
          d="M0,220 L0,185 C180,170 380,158 560,162 C660,164 720,172 780,162 C960,158 1160,170 1440,185 L1440,220 Z"
