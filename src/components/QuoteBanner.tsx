...
export default function QuoteBanner() {
  ...
  return (
    <div className="shrink-0 relative z-10 border-b border-gray-800/40 bg-black/10 px-4 py-1.5 overflow-x-auto scrollbar-hide">
      <p className="text-[11px] italic text-gray-500 whitespace-nowrap">
